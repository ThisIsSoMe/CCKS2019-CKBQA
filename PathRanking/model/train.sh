...
nohup python -u main.py --gpu 4 --model 'bert_sharecomparing' --neg_fix --batch_size 16 --train_file '../data/train.json' --valid_file '../data/valid.json' --output_dir 'saved_sharebert_negfix' --requires_grad >saved_sharebert_negfix/log.txt &
